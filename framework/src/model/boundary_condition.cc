...
//   // TODO Take care of the case where more than one bc is applied to the same boundary
...
//       global_stiffness.coeffRef(global_i_index, global_i_index) = 1.0;
...
void DirichletBoundaryCondition::Enforce(Eigen::MatrixXd &global_stiffness,
                                       Eigen::VectorXd &global_rhs) const {
  enforcement_strategy_.Enforce(global_stiffness, global_rhs, boundary_function_,
