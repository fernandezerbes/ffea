...
class Equation {
 ...
 private:
  ...
  void Integrate(PhysicalRegion& region, Element& element);
...
class EquationTerm {
 public:
  ...
  virtual void Process(PhysicalRegion& region, Element& element, size_t integration_point_idx) = 0;
...
class StiffnessTerm : public MatricialEquationTerm {
 public:
  ...
  virtual void Process(PhysicalRegion& region, Element& element,
                       size_t integration_point_idx) override;
};
